...
<template>
  <component
    ...
    :title="label"
    :class="{
      'text-n-slate-11 bg-n-slate-4 shadow-sm outline outline-1 outline-n-weak font-semibold':
        isActive && !hasActiveChild,
      'text-n-slate-11 bg-n-slate-3 outline outline-1 outline-n-weak font-medium':
        hasActiveChild,
